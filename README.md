...
1. Download the cypress jar and move it into the 'CypressRepo/com/mojang/minecraft/a1.0.16.05_20/' folder
 and rename it to minecraft-a1.0.16.05_20.jar
2. Run a python web server in the CypressRepo folder using run_python_server.sh on linux/macos or run_python_server.bat on windows
